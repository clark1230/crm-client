    ...
    <div style="min-width:1150px;max-height:560px;">
        <Form ref="customerForm" :model="customerForm" :rules="customerRule" :label-width="100" inline>
            ...
            <Form-item label="关单人：" style="width:263px" prop="guandan">
                <Select v-model="customerForm.guandan" placeholder="请选择关单人">
...
<script>
    ...
    export default {
        ...
        data() {
            ...
            const validateGuandan = (rule,value,callback) => {
                if (value === ''){
                    callback(new Error("请选择关单人!"));
                }else {
                    callback();
                }
            }
            ...
            return {
                ...
                customerRule:{
                    realName:[
                        ...
                        {validator:validateGuandan,required:true,trigger:'change'}
                    ],isMarket:[
            ...
            handleSubmit(name){
                ...
                _this.$refs[name].validate((valid) => {
                    if (valid) {
                        ...
                        formData.customerId = _this.customerForm.customerId;
                        formData.realName = _this.customerForm.realName;
                        formData.sex = _this.customerForm.sex;
                        formData.age = _this.customerForm.age;
                        formData.nativePlace = _this.customerForm.nativePlace;
                        formData.tel = _this.customerForm.tel;
                        formData.wechatNo = _this.customerForm.wechatNo;
                        formData.qq = _this.customerForm.qq;
                        formData.educationBg = _this.customerForm.educationBg;
                        formData.graduateTime = _this.customerForm.graduateTime;
                        formData.graduteFrom = _this.customerForm.graduteFrom;
                        formData.majorIn = _this.customerForm.majorIn;
                        formData.workAge = _this.customerForm.workAge;
                        formData.workExperience = _this.customerForm.workExperience;
                        formData.job = _this.customerForm.job;
                        formData.educateExperience = _this.customerForm.educateExperience;
                        formData.customerState = _this.customerForm.customerState;
                        formData.customerLevel = _this.customerForm.customerLevel;
                        formData.targetSkill = _this.customerForm.targetSkill;
                        formData.userId = _this.customerForm.userId;
                        formData.guandan = _this.customerForm.guandan;
                        formData.isMarket = _this.customerForm.isMarket;
                        formData.recruitChannel = _this.customerForm.recruitChannel;
                        formData.introducer = _this.customerForm.introducer;
                        formData.memo = _this.customerForm.memo;
                        //异步提交数据
                        this.$.post(GLOBAL.serverUrl()+"/customer/editCustomerInfo",formData,function(resp){
                            if(resp.code === 600){
